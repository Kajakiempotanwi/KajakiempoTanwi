        ...
        <Layout>
            <div className="overflow-hidden w-full z-10">
                <div className="relative object-bottom flex items-center min-h-[12rem] max-h-[13rem] overflow-hidden justify-center w-full">
                    <div className="w-full h-full object-cover min-h-[12rem] max-h-[13rem] object-center -mt-4 -z-20">
                        <StaticImage
                            className="w-full h-full object-cover object-center min-h-[12rem] max-h-[13rem] absolute inset-0"
                            loading="eager"
