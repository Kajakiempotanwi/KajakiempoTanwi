...
const SzlakKajakowy = () => {
    ...
    const trackData = data.datoCmsSzlak;
    const { trasa, title, stitle } = trackData;
    ...
    return (
        <Layout>
            ...
            <div className="mb-6 mt-10 md:my-16">
                ...
                <h1 className="font-bold text-lg lg:text-xl text-gray-700">
                    {title}
                </h1>
            </div>
                        ...
                        <div className="flex flex-col lg:flex-row mt-4 md:my-10 text-start">
                            <div className="w-full lg:w-2/6 rounded-lg mb-6 px-4">
                                <div className="flex items-center justify-start">
                                    ...
                                    <p className="font-bold">{item.czas}</p>
                                </div>
                                ...
                                <div className="flex items-center justify-start ml-1 my-2">
                                    ...
                                    <p className="font-bold">{item.poziom}</p>
                                </div>
                                ...
                                <div className="flex items-center justify-start ml-1">
                                    ...
                                    <p className="font-bold">{item.km}</p>
                                </div>
                            </div>
